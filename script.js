const centersData = { 
    tokkari: [
        ...
        { 
            ...
            description: 'Йо и Кацу очень любят друг друга, но Йо считает себя главной в этой паре.', 
            photo: 'couple.png' 
        }
    ], 
    kamogawa: [
        { 
            ...
            description: 'Ару всем всегда недовольна. Разбудили? Ару злится. Покормили? Ару злится.', 
            photo: 'aru.png' 
        }
    ],
    sasha: [
